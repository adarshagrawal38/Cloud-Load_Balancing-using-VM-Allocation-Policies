...
public class FuzzySetSimulation{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Mean of CPU utilization "+MathUtil.mean(meanCPUUtilization));
			System.out.println("Mean of Bandwidth utilization "+MathUtil.mean(meanbwtilization));
			System.out.println("Mean of memory utilization "+MathUtil.mean(meanmemUtilization));
