...
//
public class NativepolicySimulation{
	...
	static VmAllocationPolicySimple nativeObj;

	private static List<Double> meanCPUUtilization = new ArrayList<>();

	private static List<Double> meanbwtilization = new ArrayList<>();

	private static List<Double> meanmemUtilization = new ArrayList<>();
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting simple vm allocation policy simulation...");
		...
		try {
			...
			for(UsageCollector uselists : nativeObj.getUsageCollectors()) {
				...
				meanCPUUtilization.add(MathUtil.stDev(uselists.getCpuUtilization()));				
				meanbwtilization.add(MathUtil.stDev(uselists.getBwUtilization()));
				meanmemUtilization.add(MathUtil.stDev(uselists.getMemUtilization()));
			...
			System.out.println("SD of CPU utilization "+MathUtil.mean(meanCPUUtilization));
			System.out.println("SD of Bandwidth utilization "+MathUtil.mean(meanbwtilization));
			System.out.println("SD of memory utilization "+MathUtil.mean(meanmemUtilization));
